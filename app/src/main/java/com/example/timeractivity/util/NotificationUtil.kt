...
import com.example.timeractivity.AppConstants
import com.example.timeractivity.R
import com.example.timeractivity.TimerActivity
import com.example.timeractivity.TimerNotificationActionReceiver
    ...
    companion object {
        ...
        fun showTimerExpired(context: Context){
            ...
            nBuilder.setContentTitle("Timer Expired!")
                ...
                .addAction(R.drawable.play_arow, "Start", startPendingIntent)
        ...
        fun showTimerPaused(context: Context){
            ...
            nBuilder.setContentTitle("Timer is paused.")
                ...
                .setContentIntent(getPendingIntentWithStack(context, TimerActivity::class.java))
                .setOngoing(true)
                .addAction(R.drawable.play_arow, "Resume", resumePendingIntent)
